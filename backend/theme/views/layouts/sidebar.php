<aside class="main-sidebar sidebar-dark-blue elevation-4">
    <!-- Brand Logo -->
    <a href="index.php?r=site/index" class="brand-link" style="text-align: left;">
<!--        <img src="--><?php //echo Yii::$app->request->baseUrl; ?><!--/uploads/logo/ab_logo.jpg" alt="mmc" class="brand-image">-->
        <img src="<?php echo Yii::$app->request->baseUrl; ?>/uploads/logo/LOGO_new150.png" alt="mmc" width="25%">
                <span style="margin-left: 20px; " class="brand-text font-weight-light">CubicPlus</span>
    </a>
...
<!--                </li>-->
                ...
                <li class="nav-item has-treeview has-sub">
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <li class="nav-item">
                            <a href="index.php?r=productcategory/index" class="nav-link productcategory">
                                <i class="far fa-circlez nav-icon"></i>
                                <p>กลุ่มสินค้า</p>
                            </a>
                        </li>
